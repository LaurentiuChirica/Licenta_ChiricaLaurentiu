...
$imagePath = '../images/';
$cssPath = '../'; // Specify the relative path to the CSS files
...
<head>
    ...
    <!--[if lte IE 6]>  
        <link rel="stylesheet" href="{$cssPath}fixIE.css" type="text/css" />   
    <![endif]-->
INITHTML;
$script = <<< SCRIPT
    <link rel="stylesheet" type="text/css" href="{$cssPath}JS/jquery.fancybox.css" media="screen" />
	<script type="text/javascript" src="{$cssPath}JS/jquery.min.js"></script>
	<script type="text/javascript" src="{$cssPath}JS/jquery.easing.js"></script>
	<script type="text/javascript" src="{$cssPath}JS/jquery.fancybox.pack.js"></script>
...
<body>
  ...
  <div id="header">
        <div id="title">
            <img src="{$imagePath}monitoralfa.png" width="100" alt="PATR"></img> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
