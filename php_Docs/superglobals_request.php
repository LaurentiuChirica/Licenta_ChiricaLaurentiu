...
<body>
  <div class="main-content">
    ...
    <div class="main-content-container">
      <div class="presentation-title">$_REQUEST</div>
      ...
      <div class="info-container">
        <div class="info-content-container">
          <p class="info-content">Super-variabila globală $_REQUEST a PHP este utilizată pentru a stoca datele după ce un formular HTML a fost trimis.</p>

          <p class="info-content">În exemplul de mai jos este afișat un formular cu un câmp de intrare și un buton de trimitere. Atributul action al etichetei &lt;form> specifică fișierul în care sunt transferate datele din formular atunci când utilizatorul face clic pe "Submit" pentru a-l trimite.</p>
          ...
          <div class="static-code-example">
            ...
            <span class="php-syntax-code">&nbsp;$nume = $_REQUEST['fname'];</span>
