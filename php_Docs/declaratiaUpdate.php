...
<body>
  <div class="main-content">
    ...
    <div class="main-content-container">
      <div class="presentation-title">Declaratia Update</div>
      ...
      <div class="info-container">
        <div class="info-content-container">
          <h1>La ce este folosita declaratia Update?</h1>
          ...
          <p class="info-content">Înregistrările existente ale unui tabel pot fi actualizate cu ajutorul instrucțiunii UPDATE.</p>
          
          <h2>Sintaxa:</h2>
          
          <div class="static-code-example">
            <span class="php-syntax-example">UPDATE numeTabel</span>
            
            <span class="php-syntax-example">SET coloana1=valoare, coloana2=valoare2,...</span>
            
            <span class="php-syntax-example">WHERE o_coloana=o_valoare</span>
          </div>

          <p class="info-content">În sintaxa UPDATE, țineți cont de clauza WHERE: Înregistrarea sau înregistrările care trebuie să fie actualizate sunt specificate prin clauza WHERE. Toate înregistrările vor fi actualizate dacă nu este inclusă clauza WHERE!</p>

          <p class="info-content">În baza de date "Student", următoarele exemple actualizează înregistrarea  cu id = 2</p>
          ...
          <div class="static-code-example">
            ...
            <span class="php-syntax-code">$sql = "UPDATE MyGuests SET nume='Doe' WHERE id=2";</span>

            <span class="php-syntax-code"></span>   

            <span class="php-syntax-code">if ($conn->query($sql) === TRUE) {</span>

            <span class="php-syntax-code">&nbsp;  echo "Înregistrare actualizată  cu succes";</span>

            <span class="php-syntax-code">} else {</span>

            <span class="php-syntax-code">&nbsp;echo "Eroare la actualizarea înregistrării: " . $conn->error;</span>
          ...
          <div class="static-code-example">
            ...
            <span class="php-syntax-code">&nbsp;$stmt = $conn->prepare($sql);</span>
            
            <span class="php-syntax-code"></span>
            
            <span class="php-syntax-code">&nbsp;$stmt->execute();</span>

            <span class="php-syntax-code">&nbsp;echo $stmt->rowCount() . " înregistrări actualizate cu succes";</span>
