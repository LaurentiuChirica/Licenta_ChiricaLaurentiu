...
<body>
  <div class="main-content">
    ...
    <div class="main-content-container">
      ...
      <div class="info-container">
        <h1>Instalați WAMPP</h1>

        <div class="info-content-container">
          <p class="info-content">Descărcați cea mai recentă versiune de pe site-ul oficial <a href="https://sourceforge.net/projects/wampserver/" target="_blank">WAMPP</a></p>

          <p class="info-content">Pentru a instala WAMPP pe Windows, puteți urma acești pași:</p>

          <h2>Pasul 1: Începeți instalarea</h2>

          <p class="info-content">Pentru a instala WAMPP, faceți dublu clic pe fișierul descărcat:</p>

          <img src="/images/install-wampp-step-1.png" class="tutorial-images">
          ...
          <img src="/images/install-wampp-step-2.png" class="tutorial-images">

          <h2>Pasul 3: Desemnarea dosarului de instalare</h2>

          <p class="info-content">Pentru a instala wAMPP, alegeți un dosar. Se recomandă instalarea WAMPP în folderul c:xampp. Pentru a trece la pasul următor, faceți clic pe butonul Next (Următorul).</p>

          <img src="/images/install-wampp-step-3.png" class="tutorial-images">

          <h2>Pasul 4: Porniți instalarea XAMPP.</h2>

          <p class="info-content">Acum puteți începe instalarea WAMPP. Pentru a începe instalarea, faceți clic pe butonul Next (Următorul). Aceasta se va termina în scurt timp.</p>

          <img src="/images/install-wampp-step-4.png" class="tutorial-images">
        </div>
      </div>
      ...
      <div class="info-container">
        ...
        <div class="info-content-container">
          ...
          <img src="/images/install-xampp-step-1.png" class="tutorial-images">

          <h2>Pasul 2: Alegeți componentele instalației</h2>

          <p class="info-content">Alegeți componentele relevante pentru instalare. Puteți alege Apache, MySQL, PHP și phpMyAdmin în această fază, deselectați următoarele elemente și apoi faceți clic pe butonul Next (Următorul) pentru a trece la următoarea etapă.</p>

          <img src="/images/install-xampp-step-2.png" class="tutorial-images">
          ...
          <img src="/images/install-xampp-step-3.png" class="tutorial-images">
          ...
          <img src="/images/install-xampp-step-4.png" class="tutorial-images">
          ...
          <img src="/images/install-xampp-step-5.png" class="tutorial-images">
          ...
          <img src="/images/install-xampp-step-6.png" class="tutorial-images">
          ...
          <img src="/images/install-xampp-step-7.png" class="tutorial-images">
          ...
          <img src="/images/install-xampp-step-8.png" class="tutorial-images">
        </div>
      </div>
    </div>
  </div>
